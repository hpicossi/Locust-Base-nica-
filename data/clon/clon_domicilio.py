...
body_insertar_domicilio_cordoba = {
    ...
    "p_altura": "1234",   # Número de puerta
    "p_piso": "2",        # Piso del edificio
    "p_dpto": "A",        # Departamento
    "p_manzana": None,    # Manzana (opcional)
    "p_lote": None,       # Lote (opcional)
    "p_torre": None,      # Torre (opcional)
    "p_oficina_local": None,  # Oficina o local (opcional)
...
parametros_domicilio_cpc = {
    "p_id_domicilio": 20  # ID del domicilio en base única (path parameter)
}
