...
parametros_persona_fisica_chapa = {
    "p_numero_interno": "2831",  # Número interno de chapa (ejemplo basado en datos anteriores)
    "p_id_tipo_servicio": 3      # ID del tipo de servicio (ejemplo: 3 para taxi)
}

# Parámetros alternativos para probar diferentes chapas
parametros_persona_fisica_chapa_alternativos = {
    "p_numero_interno": "1234",  # Otro número de chapa para probar
    "p_id_tipo_servicio": 1      # Otro tipo de servicio
}
...
parametros_chapas_por_cuil_alternativos = [
    ...
    {"p_cuil": "27123456785"},  # CUIL femenino válido
    {"p_cuil": "23123456786"},  # Otro CUIL masculino válido
    {"p_cuil": "30123456787"},  # CUIL de empresa válido
    {"p_cuil": "20123456784"},  # CUIL masculino válido con dígito verificador correcto
    {"p_cuil": "27987654329"},  # CUIL femenino válido con dígito verificador correcto
]
...
parametros_paradas_linea = {
    "p_id_trp_linea": 1  # ID de línea de transporte (requerido según la lógica)
}

# Parámetros opcionales para paradas por línea (comentados hasta conocer la estructura exacta)
parametros_paradas_linea_comentados = {
    # "p_id_trp_linea": 1,             # REQUERIDO - ID de la línea de transporte
    # "p_sentido": "IDA",              # Posible parámetro de sentido (IDA/VUELTA)
    # "p_estado": "ACTIVO",            # Posible parámetro de estado de la parada
    # "p_id_barrio": 1,                # Posible parámetro de ID barrio
    # "p_nombre_parada": "CENTRO",     # Posible parámetro de nombre de parada
    # "p_codigo": "001",               # Posible parámetro de código de parada
}

# Comentarios sobre el endpoint de paradas por línea
parametros_paradas_linea_comentarios = {
    # Este endpoint consulta paradas de una línea específica de transporte
    # NO usa paginación - retorna directamente LineasParadasResponseSchema | None
    # Requiere p_id_trp_linea como parámetro obligatorio
    # Retorna información de la línea con sus paradas:
    # - id_empresa: identificador de la empresa
    # - nombre_empresa: nombre de la empresa
    # - id_linea: identificador de la línea
    ...
    #   * longitud: coordenada longitud
    #
    # El endpoint requiere permisos específicos (servicio_context 142)
    # URL: /lineas/paradas
    # Método: GET
    # Response: LineasParadasResponseSchema | None
    #
    # El endpoint valida que exista el ID de línea antes de procesar la consulta
    # Filtra paradas que tengan id_trp_parada y codigo válidos
    # Retorna None si no se encuentran paradas válidas para la línea
}
